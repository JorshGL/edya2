  ...
  return (
    <div className="flex flex-col">
      <div className="flex h-1/6 w-full items-center px-5 py-2 gap-3 justify-around">
        <div className="flex flex-col items-center max-h-full aspect-square justify-center rounded-full overflow-hidden p-[2px] bg-gradient-to-tr from-custom-yellow-main via-custom-red-main to-custom-purple-main mr-auto">
          <img
      ...
      <div className="px-5 font-light text-xs">
        ...
        tincidunt, nisl vitae ultricies lacinia, nisl nisl aliquet nisl, nec
      </div>
